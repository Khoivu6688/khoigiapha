...
export default function FamilyNodeCard({
  ...
  const content = (
    <div
      ...
      className={`group py-2 px-1 w-18 sm:w-22 md:w-24 flex flex-col items-center justify-start transition-all duration-300 hover:-translate-y-1 hover:shadow-xl relative bg-white/70 rounded-2xl
